...
const loadCategories = data => {
  ...
  data.forEach(category => {
    nav.innerHTML += `
      <button id="category-${category.category_id}" class="category-btn text-left xl:text-center p-3">${category.category_name}</button>
    `
  });
      ...
      <div class="modal-overlay" id="modal-overlay">
        <div class="modal-div text-center w-5/6 md:w-3/5 xl:w-1/2 flex flex-col items-center bg-base-200">
          <div class="relative w-full">
            <button class="btn-accent absolute right-3 top-3 py-4 px-6 rounded-xl font-bold" id="modal-close-btn">X</button>
          ...
          <div class="grid grid-cols-3 items-center mb-5">
            ...
            <div class="rating rating-md rating-half mx-2" id="ratings-${news._id}">
    ...
    <div class="card md:card-side bg-base-200 shadow-lg mb-7 p-2">
      ...
      <div class="card-body py-4 px-6">
        ...
        <div class="card-actions grid grid-cols-2 lg:grid-cols-4 items-center">
          ...
          <button class="text-white btn-accent py-1 px-6 w-fit ml-auto rounded-md" onclick="displayModal('${news._id}')">Details</button>
        </div>
      </div>
    </div>
    `
